...
\end{center}
\begin{itemize}
    \item FCOS achieves highest AP@0.5 = 1.2\% --- best detector
    \item Faster R-CNN peaks at 0.74\% (epoch 1), then declines
...
\vspace{0.5em}
\textbf{Paper reference:} Wu et al.\ report FCOS AP@0.5 $\approx$ 28.5\% on full RSNA dataset (20 epochs).
\end{frame}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Converges faster, non-zero AP from epoch 1
    \end{itemize}
